...
class JpaBookRepositoryTest {
    ...
    void shouldReturnCorrectBooksList() {
        ...
        assertThat(books.get(1).getAuthor()).usingRecursiveComparison().isEqualTo(getAuthor(2L));
    ...
    void shouldSaveNewBook() {
        ...
        Optional<Book> actualBook = jpaBookRepository.findById(4L);
    ...
    void shouldSaveUpdatedBook() {
        Book expectedBook = new Book(FIRST_BOOK_ID, "new title",
                getAuthor(FIRST_BOOK_ID + 1L),getGenre(FIRST_BOOK_ID + 1L), getSingleComment(FIRST_BOOK_ID + 1L));
        jpaBookRepository.save(expectedBook);
    ...
    private static List<Comment> getSingleComment(long id) {
